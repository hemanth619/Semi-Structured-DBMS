...
public class Convert {
  ...
  /**
   * read 12 bytes from given byte array at the specified position
   * convert it to a intervaltype
   *
   * @param data     a byte array
   * @param position the position in data[]
  ...
  /**
   * update an intervaltype in the given byte array at the specified position
   *
   * @param data a byte array
   * @throws java.io.IOException I/O errors
   * @param    value the value to be copied into the data[]
