...
/**
 * Intefrace of a IntervalTree index header page. Here we use a HFPage as head page
 ...
 */
class IntervalTreeHeaderPage extends HFPage {
	 ...
	 */
	public IntervalTreeHeaderPage(PageId pageno) throws ConstructPageException {
		super();
		try {
	 ...
	 */
	public IntervalTreeHeaderPage() throws ConstructPageException {
		super();
		try {
			Page apage = new Page();
