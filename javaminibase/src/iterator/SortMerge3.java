...
public class SortMerge3 extends Iterator implements GlobalConst
{
  ...
  List<Tuple> listOfTuple1 = new ArrayList<>();
  int start = 0;
   ...
   */
  public SortMerge3(AttrType    in1[],               
		   int     len_in1,                        
		   short   s1_sizes[],
		   AttrType    in2[],                
		   int     len_in2,                        
...
//		    		  continue;
//		    	  }
		    	  while ((tuple1 = p_i1.get_next()) != null && ((comp_res = TupleUtils.CompareTupleWithTuple(sortFldType, tuple1, jc_in1, tuple2, jc_in2, true)) == 4) && (_in1[0].attrType == AttrType.attrInterval || _in2[0].attrType == AttrType.attrInterval)) {
		    		  io_buf1.Put(tuple1);
		    		  listOfTuple1.add(tuple1);
//		    		  comp_res = TupleUtils.CompareTupleWithTuple(sortFldType, tuple1,
//							  jc_in1, tuple2, jc_in2, true);
...
//		    	  }
		    	  ...
		    	  TempTuple2 = tuple2;
		    	  for (int i=start; i<listOfTuple1.size(); i++) {
		    		  TempTuple1 = listOfTuple1.get(i);
		    		  
		    		  while ((tuple2 = p_i2.get_next()) != null && ((comp_res = TupleUtils.CompareTupleWithTuple(sortFldType, TempTuple1, jc_in1, tuple2, jc_in2, true)) == 4) && (_in1[0].attrType == AttrType.attrInterval || _in2[0].attrType == AttrType.attrInterval)) {
			    		  io_buf2.Put(tuple2);
