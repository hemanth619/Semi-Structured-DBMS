 ...
 * 
 * FOR AD PURPOSES ONLY!!!!!
 */
public class SortMerge3 extends Iterator implements GlobalConst {
	 ...
	 */
	public SortMerge3(AttrType in1[], int len_in1, short s1_sizes[], AttrType in2[], int len_in2, short s2_sizes[],
