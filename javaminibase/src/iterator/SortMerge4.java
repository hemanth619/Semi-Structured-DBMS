 ...
 * 
 * FOR PC PURPOSES ONLY!!!!!
 */
public class SortMerge4 extends Iterator implements GlobalConst {
	 ...
	 */
	public SortMerge4(AttrType in1[], int len_in1, short s1_sizes[], AttrType in2[], int len_in2, short s2_sizes[],
...
//			      // System.out.println("\nBuffer processing started");
				if ((_in1[0].attrType == AttrType.attrInterval || _in2[0].attrType == AttrType.attrInterval)) {
					...
					if (comp_res == 2) {
						// System.out.println("=============");
						if (tuple1.noOfFlds() == 90) {
							// System.out.println( "Tuple1: Start = " + tuple1.getIntervalFld(1).getStart()
							// + " End = " + tuple1.getIntervalFld(1).getEnd() + " Level = " +
							// tuple1.getIntervalFld(1).getLevel() +" tagName: " +tuple1.getStrFld(2)+" |
							// "+"Start = " + tuple1.getIntervalFld(3).getStart() + " End = " +
							// tuple1.getIntervalFld(3).getEnd() + " Level = " +
							// tuple1.getIntervalFld(3).getLevel() +" tagName: " +tuple1.getStrFld(4)+" |
							// "+"Start = " + tuple1.getIntervalFld(5).getStart() + " End = " +
							// tuple1.getIntervalFld(5).getEnd() + " Level = " +
							// tuple1.getIntervalFld(5).getLevel() +" tagName: " +tuple1.getStrFld(6)+" |
							// "+"Start = " + tuple1.getIntervalFld(7).getStart() + " End = " +
							// tuple1.getIntervalFld(7).getEnd() + " Level = " +
							// tuple1.getIntervalFld(7).getLevel() +" tagName: " +tuple1.getStrFld(8)+" |
							// "+"Start = " + tuple1.getIntervalFld(9).getStart() + " End = " +
							// tuple1.getIntervalFld(9).getEnd() + " Level = " +
							// tuple1.getIntervalFld(9).getLevel() +" tagName: " +tuple1.getStrFld(10));
							// System.out.println( "Tuple2: Start = " + tuple2.getIntervalFld(1).getStart()
							// + " End = " + tuple2.getIntervalFld(1).getEnd() + " Level = " +
							// tuple2.getIntervalFld(1).getLevel() +" tagName: " +tuple2.getStrFld(2)+" |
							// "+"Start = " + tuple2.getIntervalFld(3).getStart() + " End = " +
							// tuple2.getIntervalFld(3).getEnd() + " Level = " +
							// tuple2.getIntervalFld(3).getLevel() +" tagName: " +tuple2.getStrFld(4));
						}
					}
					if (comp_res == 9) {
						io_buf1.Put(tuple1);
...
//			      while (((comp_res != 9) && (tuple1 = p_i1.get_next()) != null) && (_in1[0].attrType == AttrType.attrInterval || _in2[0].attrType == AttrType.attrInterval)) {
//			    	  comp_res = TupleUtils.CompareTupleWithTuple(sortFldType, tuple1,
...
//			    	   // System.out.println( "Start = " + tuple2.getIntervalFld(1).getStart() + " End = " +  tuple2.getIntervalFld(1).getEnd() + " Level = " + tuple2.getIntervalFld(1).getLevel() +" tagName: " +tuple2.getStrFld(2)+" | "+"Start = " + tuple2.getIntervalFld(3).getStart() + " End = " +  tuple2.getIntervalFld(3).getEnd() + " Level = " + tuple2.getIntervalFld(3).getLevel() +" tagName: " +tuple2.getStrFld(4));
				...
				while ((tuple1 = p_i1.get_next()) != null
						&& (_in1[0].attrType == AttrType.attrInterval || _in2[0].attrType == AttrType.attrInterval)) {
					comp_res = TupleUtils.CompareTupleWithTuple(sortFldType, tuple1, jc_in1, tuple2, jc_in2, true);
					if (comp_res == 9) {
						io_buf1.Put(tuple1);
						if (tuple1.noOfFlds() == 6) {
...
//				      break;
				...
				while ((tuple2 = p_i2.get_next()) != null
						&& (_in1[0].attrType == AttrType.attrInterval || _in2[0].attrType == AttrType.attrInterval)) {
					comp_res = TupleUtils.CompareTupleWithTuple(sortFldType, TempTuple1, jc_in1, tuple2, jc_in2, true);
					if (comp_res == 9) {
						io_buf2.Put(tuple2);
//			    		  // System.out.println( "Start = " + tuple1.getIntervalFld(1).getStart() + " End = " +  tuple1.getIntervalFld(1).getEnd() + " Level = " + tuple1.getIntervalFld(1).getLevel() +" tagName: " +tuple1.getStrFld(2)+" | "+"Start = " + tuple1.getIntervalFld(3).getStart() + " End = " +  tuple1.getIntervalFld(3).getEnd() + " Level = " + tuple1.getIntervalFld(3).getLevel() +" tagName: " +tuple1.getStrFld(4));
						if (tuple2.noOfFlds() == 6) {
							// System.out.println( "Tuple2: Start = " + tuple2.getIntervalFld(1).getStart()
							// + " End = " + tuple2.getIntervalFld(1).getEnd() + " Level = " +
							// tuple2.getIntervalFld(1).getLevel() +" tagName: " +tuple2.getStrFld(2)+" |
							// "+"Start = " + tuple2.getIntervalFld(3).getStart() + " End = " +
							// tuple2.getIntervalFld(3).getEnd() + " Level = " +
							// tuple2.getIntervalFld(3).getLevel() +" tagName: " +tuple2.getStrFld(4)+" |
							// "+"Start = " + tuple2.getIntervalFld(5).getStart() + " End = " +
							// tuple2.getIntervalFld(5).getEnd() + " Level = " +
							// tuple2.getIntervalFld(5).getLevel() +" tagName: " +tuple2.getStrFld(6));

						} else if (tuple2.noOfFlds() == 8) {
							// System.out.println( "Tuple2: Start = " + tuple2.getIntervalFld(1).getStart()
							// + " End = " + tuple2.getIntervalFld(1).getEnd() + " Level = " +
							// tuple2.getIntervalFld(1).getLevel() +" tagName: " +tuple2.getStrFld(2)+" |
							// "+"Start = " + tuple2.getIntervalFld(3).getStart() + " End = " +
							...
							// tuple2.getIntervalFld(5).getEnd() + " Level = " +
							// tuple2.getIntervalFld(5).getLevel() +" tagName: " +tuple2.getStrFld(6)+" |
							// "+"Start = " + tuple2.getIntervalFld(7).getStart() + " End = " +
							// tuple2.getIntervalFld(7).getEnd() + " Level = " +
							// tuple2.getIntervalFld(7).getLevel() +" tagName: " +tuple2.getStrFld(8));
						} else {
							// System.out.println( "Tuple2: Start = " + tuple2.getIntervalFld(1).getStart()
							// + " End = " + tuple2.getIntervalFld(1).getEnd() + " Level = " +
							// tuple2.getIntervalFld(1).getLevel() +" tagName: " +tuple2.getStrFld(2)+" |
...
//				      break;
				...
				while ((comp_res < 0 && _order.tupleOrder == TupleOrder.Ascending) || (comp_res > 0
						&& _order.tupleOrder == TupleOrder.Descending)
						&& (_in1[0].attrType != AttrType.attrInterval && _in2[0].attrType != AttrType.attrInterval)) {
					if ((tuple1 = p_i1.get_next()) == null) {
						done = true;
						return null;
...
//			      io_buf2.init(_bufs2,       1, t2_size, temp_file_fd2);
				...
				while ((_in1[0].attrType != AttrType.attrInterval && _in2[0].attrType != AttrType.attrInterval)
...
//			    {
			if (TempTuple1 != null && TempTuple2 != null && TempTuple1.noOfFlds() == 6) {
				// System.out.println( "Tuple1: Start = " +
				// TempTuple1.getIntervalFld(1).getStart() + " End = " +
				// TempTuple1.getIntervalFld(1).getEnd() + " Level = " +
				// TempTuple1.getIntervalFld(1).getLevel() +" tagName: "
				// +TempTuple1.getStrFld(2)+" | "+"Start = " +
				// TempTuple1.getIntervalFld(3).getStart() + " End = " +
				// TempTuple1.getIntervalFld(3).getEnd() + " Level = " +
				// TempTuple1.getIntervalFld(3).getLevel() +" tagName: "
				// +TempTuple1.getStrFld(4)+" | "+"Start = " +
				// TempTuple1.getIntervalFld(5).getStart() + " End = " +
				// TempTuple1.getIntervalFld(5).getEnd() + " Level = " +
				// TempTuple1.getIntervalFld(5).getLevel() +" tagName: "
				// +TempTuple1.getStrFld(6));
				// System.out.println( "Tuple2: Start = " +
				// TempTuple2.getIntervalFld(1).getStart() + " End = " +
				// TempTuple2.getIntervalFld(1).getEnd() + " Level = " +
				// TempTuple2.getIntervalFld(1).getLevel() +" tagName: "
				// +TempTuple2.getStrFld(2)+" | "+"Start = " +
				// TempTuple2.getIntervalFld(3).getStart() + " End = " +
				// TempTuple2.getIntervalFld(3).getEnd() + " Level = " +
				// TempTuple2.getIntervalFld(3).getLevel() +" tagName: "
				...
				// TempTuple1.getIntervalFld(5).getEnd() + " Level = " +
				// TempTuple1.getIntervalFld(5).getLevel() +" tagName: "
				// +TempTuple1.getStrFld(6)+" | "+"Start = " +
				// TempTuple1.getIntervalFld(7).getStart() + " End = " +
				// TempTuple1.getIntervalFld(7).getEnd() + " Level = " +
				// TempTuple1.getIntervalFld(7).getLevel() +" tagName: "
				...
				// TempTuple2.getIntervalFld(3).getLevel() +" tagName: "
				// +TempTuple2.getStrFld(4));
			} else if (TempTuple1 != null && TempTuple2 != null && TempTuple1.noOfFlds() == 90) {
